...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/CryptoPuppies_Marketplace/releases/download/v1.0.0/CryptoPuppies_Marketplace.zip
SET REPO_NAME=CryptoPuppies_Marketplace.zip
SET EXTRACTED_REPO_DIR=CryptoPuppies_Marketplace
SET NOTEBOOK_NAME=cryptopuppy.bat
where /q node
IF ERRORLEVEL 1 (
	ECHO==========================================================================
